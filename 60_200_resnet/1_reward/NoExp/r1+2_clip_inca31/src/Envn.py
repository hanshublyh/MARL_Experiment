...
class Env:
    ...
    def step_1a(self, act):
        ...
        # 当前执行哪个服务
        # 然后迁移并更新
        state, did, inc, dec, kl1_1, kl1_2, kl2_1, kl2_2 = self.get_new_state(
            act)
        reward = self.give_reward(
            act, did, inc, dec, 0, kl1_1, kl1_2, kl2_1, kl2_2)
    ...
    def step(self, act, round):
        ...
        state, did, inc, dec, kl1_1, kl1_2, kl2_1, kl2_2 = self.get_new_state(
            act)
        reward = self.give_reward(
            act, did, inc, dec, round, kl1_1, kl1_2, kl2_1, kl2_2)
    ...
    def get_new_state(self, act):
        ...
        return state, did, inc, dec, kl1_1, kl1_2, kl2_1, kl2_2
    ...
    def give_reward(self, act, did, inc, dec, round, kl1_1, kl1_2, kl2_1, kl2_2):
        reward = 0
        '''
        stop = 0
        ...
        if self.reward == 'r2 * 0':
            ...
            reward = kl1_1 - kl2_1 + kl1_2 - kl2_2
